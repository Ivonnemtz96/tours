            ...
            <div class="tour-listing-details__destination-row row">
                <div class="col-xl-4 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
                    <div class="tour-listing-details__destination-left">
                        <h3 class="tour-listing-details__dastination-title">Two Capes City Tour</h3>
                        ...
                        <div class="col-lg-6 col-md-7 wow animated fadeInUp" data-wow-delay="0.1s"
                            ...
                            <ul class="tour-listing-details__included-list-one">
                                <li>
                                    ...
                                    <p>Paseo hasta el arco a bordo del increíble Crystal Boat (Lands end, colonia de leones marinos y formaciones rocosas)</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-7 wow animated fadeInUp" data-wow-delay="0.1s"
                            ...
                            <ul class="tour-listing-details__included-list-one">
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Fábrica de vidrio</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Visita guiada en Cabo San Lucas</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Cata de tequila Gratis</p>
                                </li>

                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Tiempo de compras Art Craft Area</p>
                                </li>
