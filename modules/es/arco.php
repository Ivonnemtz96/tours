...
<section class="tour-listing-details">
    <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
            ...
            <div class="tour-listing-details__top-carousel-item item">
                <div class="tour-listing-details__top-carousel-image">
                    ...
                    <div class="tour-listing-details__top-carousel-overlay">
                        ...
                        "items": [
                          {
                            "src": "assets/images/tours/arco/grandes/02.jpeg"
                          }
                        ],
                        "gallery": {
                          "enabled": true
            ...
            <div class="tour-listing-details__top-carousel-item item">
                <div class="tour-listing-details__top-carousel-image">
                    ...
                    <div class="tour-listing-details__top-carousel-overlay">
                        ...
                        "items": [
                          {
                            "src": "assets/images/tours/arco/grandes/03.jpeg"
                          }
                        ],
                        "gallery": {
                          "enabled": true
            ...
            <div class="tour-listing-details__top-carousel-item item">
                <div class="tour-listing-details__top-carousel-image">
                    ...
                    <div class="tour-listing-details__top-carousel-overlay">
                        ...
                        "items": [
                          {
                            "src": "assets/images/tours/arco/grandes/04.jpeg"
                          }
                        ],
                        "gallery": {
                          "enabled": true
            ...
            <div class="tour-listing-details__top-carousel-item item">
                <div class="tour-listing-details__top-carousel-image">
                    <img src="assets/images/tours/arco/14.jpg" alt="listing-details-carousel">
                    <div class="tour-listing-details__top-carousel-overlay">
                        <a href="#"
                            class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                            data-gallery-options='{
                        "items": [
                          {
                            "src": "assets/images/tours/arco/grandes/14.jpeg"
                          }
                        ],
                        "gallery": {
                          "enabled": true
                    ...
                    <div class="tour-listing-details__destination-right">
                        ...
                        <div class="tour-listing-details__destination-info-title">
                            ...
                            <h3 class="tour-listing__card-price"
                                style="font-size: 12px; text-decoration: line-through;">$1,000 MXN</h3>
                            <h3 class="tour-listing__card-price" style="font-size: 18px;">$850 MXN</h3>
                        </div>
