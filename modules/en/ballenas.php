                    ...
                    <div class="tour-listing-details__destination-right">
                        ...
                        <div class="tour-listing-details__destination-info-title">
                                ...
                                <h3 class="tour-listing__card-price"
                                        style="font-size: 12px; text-decoration: line-through;">$120 USD</h3>
                                    <h3 class="tour-listing__card-price" style="font-size: 18px;">$102 USD</h3>
                            </div>
        ...
        <div class="tour-listing-details__row row">
            <div class="col-xl-8">
                ...
                "type": "image"
                                    ...
                                    <h3 class="tour-listing__card-title"><a href="tour1.php">Two Capes City Tours</a>
                                    </h3>
                                    <p class="tour-listing__card-text text-small">
                                        Cabo San Lucas y San José del Cabo, un recorrido que nos muestra lo mejor de
                                        estas ciudades, la historia y el significado actual que este increíble destino
