            ...
            <div class="tour-listing-details__destination-row row">
                <div class="col-xl-4 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
                    <div class="tour-listing-details__destination-left">
                        <h3 class="tour-listing-details__dastination-title">La Paz, Balandra</h3>
                    ...
                    <div class="tour-listing-details__destination-right">
                        ...
                        <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.5s"
                            ...
                            <div class="tour-listing-details__destination-info-title">
                                ...
                                <h4 class="tour-listing-details__destination-info-bottom">La Paz - Balandra Beach</h4>
                            </div>
                        </div>
                        <div class="tour-listing-details__destination-info-title">
                                <h4 class="tour-listing-details__destination-info-top">Special Offer</h4>
                                <h3 class="tour-listing__card-price"
                                        style="font-size: 12px; text-decoration: line-through;">$130 USD</h3>
                                    <h3 class="tour-listing__card-price" style="font-size: 18px;">$111 USD</h3>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-7 wow animated fadeInUp" data-wow-delay="0.1s"
                            ...
                            <ul class="tour-listing-details__included-list-one">
                                <li>
                                    ...
                                    <p>Arrival at Balandra for beach time (approx. 1:30)</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Visit to the La Paz Malecón</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Handicraft Market and Pearl Jewelry Stores</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Guided tour with history and culture of the area</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                ...
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Brief stop in Todos Santos Pueblo Mágico</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Lunch at a Mexican restaurant</p>
                                </li>
                                <li>
                                    <i class="fas fa-check-circle"></i>
                                    <p>Semarnat bracelet for entry to the natural area</p>
                                </li>
